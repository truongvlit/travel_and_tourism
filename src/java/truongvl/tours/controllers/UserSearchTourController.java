 ...
 * @author Nero
 */
public class UserSearchTourController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (check) url = "destinations.jsp?page=" + pageId;
            else {
                url = "destinations.jsp?page=" + pageId + "&txtSearch=" + search;
            }
        } catch (Exception e) {
            log("ERROR at UserSearchTourController: " + e.getMessage());
        } finally {

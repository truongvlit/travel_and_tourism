                    ...
                    <form action="<%= path%>/TourMainController" method="POST">
                        <div class="row">
                            <div class="input-group form-group col-xl-6">
                                ...
                                <input type="text" class="form-control input" name="txtCategory" style="font-size: 15px;" value="<%= dto.getCategory() == null ? "" : dto.getCategory()%>">
                            </div>
                            <div class="input-group form-group col-xl-6">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" style="font-size: 15px; display: flex; justify-content: center; width: 100px;">Name</span>
                                </div>
                                <input type="text" class="form-control input" name="txtName" style="font-size: 15px;" value="<%= dto.getName() == null ? "" : dto.getName()%>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6">
                        ...
                        <div class="row">
                            <div class="input-group form-group col-xl-6">
                                ...
                                <input type="date" class="form-control input" name="txtStartTime" style="font-size: 15px;" value="<%= dto.getStartTime() == null ? "" : dto.getStartTime()%>">
                            </div>
                            <div class="input-group form-group col-xl-6">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" style="font-size: 15px; display: flex; justify-content: center; width: 100px;">End time</span>
                                </div>
                                <input type="date" class="form-control input" name="txtEndTime" style="font-size: 15px;" value="<%= dto.getEndTime() == null ? "" : dto.getEndTime()%>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6">
                        ...
                        <div class="row">
                            <div class="input-group form-group col-xl-12">
                                ...
                                <input type="text" class="form-control input" name="txtDestination" style="font-size: 15px;
                        ...
                        <div class="row">
                            <div class="input-group form-group col-xl-6">
                                ...
                                <input type="text" class="form-control input" name="txtInfantPrice" style="font-size: 15px;" value="<%= dto.getInfantPrice() == null ? "" : dto.getInfantPrice()%>">
                            </div>
                            <div class="input-group form-group col-xl-6">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" style="font-size: 15px; display: flex; justify-content: center; width: 100px;">Child price</span>
                                </div>
                                <input type="text" class="form-control input" name="txtChildPrice" style="font-size: 15px;" value="<%= dto.getChildPrice() == null ? "" : dto.getChildPrice()%>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6">
                        ...
                        <div class="row">
                            <div class="input-group form-group col-xl-6">
                                ...
                                <input type="text" class="form-control input" name="txtAdultPrice" style="font-size: 15px;"  value="<%= dto.getAdultPrice() == null ? "" : dto.getAdultPrice()%>">
                            </div>
                            <div class="input-group form-group col-xl-6">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" style="font-size: 15px; display: flex; justify-content: center; width: 100px;">Seat</span>
                                </div>
                                <input type="text" class="form-control input" name="txtSeatAvailable" style="font-size: 15px;"  value="<%= dto.getSeatAvailable() == null ? "" : dto.getSeatAvailable()%>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6">
                        ...
                        <div class="row">
                            <div class="input-group form-group col-xl-6">
                                ...
                                <input type="file" class="input btn btn-brand-link" name="txtImage" accept="image/png, image/jpeg, image/jpg" style="font-size: 15px;" value="<%= dto.getImage() == null ? "" : dto.getImage() %>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="input-group form-group col-xl-12"  style="display: flex; justify-content: center;">
                                ...
                                <input type="submit" class="btn btn-outline-primary" name="action" value="Update" style="width: 80px; height: 50px; margin-top: 20px;"/>
                            </div>
                        </div>
                    </form>
                </div>  

            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                            ...
                                            <table class="table" style="text-align: center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<%= request.getContextPath() %>/TouristMainController?action=View&touristId=<%= ticket.getTouristId()%>"><%= ticket.getTouristId()%></a>
                                                        </td>
                    ...
                    <div style="display: flex; justify-content: center" id="pagination">
                        ...
                        %>
                        <a href="<%= request.getContextPath()%>/SearchPurchasedTicketController?page=<%= i + 1%>"><button class="btn btn-outline-info" style="margin-right: 5px; margin-bottom: 30px;"><%= i + 1%></button></a>
                            <%
                                    }
                                }
                            %>

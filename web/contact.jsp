...
<html lang="en">
    <head>
        <title>NeroTourist - Contact</title>
        <meta charset="utf-8">
        ...
        <section class="ftco-section contact-section ftco-degree-bg">
            <div class="container">
                <div class="row d-flex mb-5 contact-info">
                    ...
                    <div class="w-100"></div>
                    <div class="col-md-3">
                        <p><span>Address:</span> Quang Trung Software City, District 12, TPHCM </p>
                    </div>
                    <div class="col-md-3">
                        <p><span>Phone:</span> <a href="#">0332 987 559</a></p>
                    </div>
                    <div class="col-md-3">
                        <p><span>Email:</span> <a href="#">truongvlit@gmail.com</a></p>
                    </div>
                    <div class="col-md-3">
                        <p><span>Website</span> <a href="#">nerotourist.com</a></p>
                    </div>
                </div>
